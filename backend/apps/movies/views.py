...
class MovieViewSet(ViewSet):
    ...
    @extend_schema(
        ...
        responses={
            HTTP_200_OK:OpenApiResponse(
                ...
                response=MovieSearchSerializer(many=True)
                    ),
    ...
    def search_movies(
        ...
        **kwargs:dict[str,Any]
        ...
        """
        search_serializer:MovieSearchSerializer=MovieSearchSerializer(data=request.query_params)
    ...
    def toggle_like(
        ...
        **kwargs: dict[str, Any]
        ...
        try:
            ...
            return DRFResponse(
                data={"detail": "Invalid content_type."},
                status=HTTP_400_BAD_REQUEST
            )
        ...
        if existing_like:
            ...
            return DRFResponse(
                data={"liked": False, "likes_count": likes_count},
                status=HTTP_200_OK
            )
        ...
        return DRFResponse(
            data={"liked": True, "likes_count": likes_count},
            status=HTTP_201_CREATED
        )
    ...
    def destroy(
        ...
        **kwargs: dict[str, Any]
        ...
        try:
            ...
            return DRFResponse(
                data={"detail": "Favorite not found."},
                status=HTTP_404_NOT_FOUND
            )
