...
class MovieDetailView(APIView):
    ...
    def get(self, request: HttpRequest, movie_id: int, *args, **kwargs) -> Response:
        """
...
class MovieVideoUploadView(APIView):
    ...
    def put(self, request: HttpRequest, movie_id: int, *args, **kwargs) -> Response:
        try:
    ...
    def post(self, request: HttpRequest, movie_id: int, *args, **kwargs) -> Response:
...
class CommentView(APIView):
    ...
    def get(self, request: HttpRequest, movie_id: int, *args, **kwargs) -> Response:
        ...
        comments: QuerySet[Comment] = (
            Comment.objects.filter(movie_id=movie_id, parent=None)
    ...
    @extend_schema(
        ...
        examples=[
            OpenApiExample(
                "Example request",
                value={"text": "Great movie!", "parent": None},
                request_only=True,
            ),
        ],
    )
...
class LikeView(APIView):
    ...
    @extend_schema(
        ...
        examples=[
            OpenApiExample(
                "Like a movie",
                value={"content_type": "movie", "object_id": 1},
                request_only=True,
            ),
            OpenApiExample(
                "Like a comment",
                value={"content_type": "comment", "object_id": 5},
                request_only=True,
            ),
        ],
    )
    def post(self, request: HttpRequest, *args, **kwargs) -> Response:
        ...
        if existing_like:
            print(
                f"Active like ID: {existing_like.id}, deleted_at: {existing_like.deleted_at}"
            )
        ...
        if existing_like:
            ...
            return Response(
                {"liked": False, "likes_count": likes_count}, status=status.HTTP_200_OK
            )
...
class RatingView(APIView):
    ...
    @extend_schema(
        ...
        examples=[
            OpenApiExample("Rate a movie", value={"score": 5}, request_only=True),
        ],
    )
    def post(self, request: HttpRequest, movie_id: int, *args, **kwargs) -> Response:
        """
...
class ReviewViewSet(ViewSet):
    ...
    @action(methods=["GET"], detail=False, url_path="list", url_name="review-list")
    def list_reviews(self, request: HttpRequest, *args, **kwargs) -> Response:
    ...
    @action(methods=["POST"], detail=False, url_path="create", url_name="review-create")
    def create_review(self, request: HttpRequest, *args, **kwargs) -> Response:
    ...
    @action(methods=["GET"], detail=True, url_path="detail", url_name="review-detail")
    def retrieve_review(
        self, request: HttpRequest, pk: int = None, *args, **kwargs
    ) -> Response:
    ...
    @action(
        methods=["DELETE"], detail=True, url_path="delete", url_name="review-delete"
    )
    def delete_review(
        self, request: HttpRequest, pk: int = None, *args, **kwargs
    ) -> Response:
...
class RatingViewSet(ViewSet):
    ...
    @action(methods=["GET"], detail=False, url_path="list", url_name="rating-list")
    def list_ratings(self, request: HttpRequest, *args, **kwargs) -> Response:
    ...
    @action(methods=["POST"], detail=False, url_path="rate", url_name="rating-create")
    ...
    @action(
        methods=["DELETE"], detail=True, url_path="delete", url_name="rating-delete"
    )
    def delete_rating(
        self, request: HttpRequest, pk: int = None, *args, **kwargs
    ) -> Response:
...
class FavoriteViewSet(ViewSet):
    ...
    @action(methods=["GET"], detail=False, url_path="list", url_name="favorite-list")
    def list_favorites(self, request: HttpRequest, *args, **kwargs) -> Response:
    ...
    @action(methods=["POST"], detail=False, url_path="add", url_name="favorite-add")
    def add_favorite(self, request: HttpRequest, *args, **kwargs) -> Response:
    ...
    @action(
        methods=["DELETE"], detail=True, url_path="remove", url_name="favorite-remove"
    )
    def remove_favorite(
        self, request: HttpRequest, pk: int = None, *args, **kwargs
    ) -> Response:
