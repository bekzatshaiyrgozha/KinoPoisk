...
urlpatterns = [
    ...
    path(
        route="search/",
        view=MovieViewSet.as_view({"get": "search_movies"}),
        name="movie-search",
    ),
    path(
        route="<int:pk>/",
        view=MovieViewSet.as_view({"get": "retrieve_movie"}),
        name="movie-detail",
    ),
    path(
        route="<int:pk>/video/",
        view=MovieViewSet.as_view({"put": "upload_video", "post": "upload_video"}),
        name="movie-video",
    ),
    path(
        route="<int:pk>/comments/",
        view=MovieViewSet.as_view({"get": "get_comments", "post": "create_comment"}),
        name="movie-comments",
    ),
    path(
        route="<int:pk>/rate/",
